...
<content>
<!-- BLOCK_1 | doxcnlyo3NaSJt2dDvwxj3jhR0c -->
最近更新：2026-01-09
<!-- END_BLOCK_1 -->
...
<!-- BLOCK_7 | Ns5UduLTwo5LC1xPNlacKYdMnCb -->
再补充一个缺陷自动触发修复的 case
<!-- END_BLOCK_7 -->

<!-- BLOCK_8 | doxcno1jAtB9crjYSIoPaD8mSxe -->
## 什么是项目空间<!-- END_BLOCK_8 -->

<!-- BLOCK_9 | doxcnKfJulJpWZLnQQGaN0GQtdb -->
...
<!-- BLOCK_10 | doxcnllsA5mgB48LHcsMRLIyPab -->
<callout icon="bulb" bgc="3" bc="3">
**一句话定位**：项目空间是基于具体项目，支持不同职能协同方组成，实现对需求任务**可管理、可理解、可"成长"、可协作**的空间平台
</callout>
<!-- END_BLOCK_10 -->

<!-- BLOCK_11 | doxcnXuoTha6hxhr5JEWdJ7Fnie -->
### 项目空间的独特价值<!-- END_BLOCK_11 -->

<!-- BLOCK_12 | doxcnDvq8fzt5W8hXrnhPgcpbdd -->
<grid cols="2">
<column width="50">
  **🎯 四大核心目标**
...
<!-- BLOCK_13 | doxcnG07ecDRU5QEkaWK4JlM6zb -->
...
<!-- BLOCK_14 | Sf7GdeEIPoIU3YxkCHzc1LQ6nne -->
## <!-- END_BLOCK_14 -->

<!-- BLOCK_15 | PE7TdXIjUoiLyjxHEVDc6Tf6nHf -->
## 日常什么工作场景可以用<!-- END_BLOCK_15 -->

<!-- BLOCK_16 | PpPjdeaYMoFpJHx0ro6c8dTYnKR -->
**Meego 任务&nbsp;：**Aime 平台为 Meego 需求和缺陷预置了多个模版，帮助解决常规节点下任务内容，若需要基于业务逻辑进行自定义，可以选择调整预置模版 prompt 或 新增模版
<!-- END_BLOCK_16 -->

<!-- BLOCK_17 | IJSOdEFWRoIPI3x8TxScVOJjnte -->
**常规任务：**结合知识库的能力，我们重点优化了产品方案和技术文档两大场景的模型效果，以下是最佳实践示例：
<!-- END_BLOCK_17 -->

<!-- BLOCK_18 | YItFdjvKsohGA4xCZcJcdTD0ntc -->
...
<!-- BLOCK_19 | doxcnvVdPpP14z6J3BbVd82GaEf -->
### 业务使用案例和实际效果<!-- END_BLOCK_19 -->

<!-- BLOCK_20 | D2Zjdc4J6o6epzx7j8kcqRNDnRf -->
...
<!-- BLOCK_21 | RqWIdtZojoRTMDxfZiUc87IPnQc -->
## <!-- END_BLOCK_21 -->

<!-- BLOCK_22 | MDksd8LPSo40ECx3314cztRwn9f -->
## 使用流程<!-- END_BLOCK_22 -->

<!-- BLOCK_23 | doxcn7IwHx0AKQuSgvSZsGrAiob -->
...
<!-- BLOCK_24 | IOf3dzltEobRZ6xpMPwcSPxWnch -->
> 使用地址：
