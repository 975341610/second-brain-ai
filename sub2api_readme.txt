sub2api/README\_CN.md at main · Wei-Shaw/sub2api · GitHub



[Skip to content](https://github.com/Wei-Shaw/sub2api/blob/main/README_CN.md#start-of-content)
...
[Sign in](https://github.com/login?return_to=https%3A%2F%2Fgithub.com%2FWei-Shaw%2Fsub2api%2Fblob%2Fmain%2FREADME_CN.md)
...
* Platform
  ...
  + AI CODE CREATION
    ...
    - [MCP RegistryNew
      Integrate external tools](https://github.com/mcp)
  + DEVELOPER WORKFLOWS
    - [Actions
  ...
  + APPLICATION SECURITY
    ...
    - [Code security
      Secure your code as you build](https://github.com/security/advanced-security/code-security)
    - [Secret protection
      Stop leaks before they start](https://github.com/security/advanced-security/secret-protection)
  + EXPLORE
...
[Sign up](https://github.com/signup?ref_cta=Sign+up&ref_loc=header+logged+out&ref_page=%2F%3Cuser-name%3E%2F%3Crepo-name%3E%2Fblob%2Fshow&source=header-repo&source_repo=Wei-Shaw%2Fsub2api)
...
* [Notifications](https://github.com/login?return_to=%2FWei-Shaw%2Fsub2api) You must be signed in to change notification settings
* [Fork
  1.2k](https://github.com/login?return_to=%2FWei-Shaw%2Fsub2api)
* [Star
   8k](https://github.com/login?return_to=%2FWei-Shaw%2Fsub2api)

* [Code](https://github.com/Wei-Shaw/sub2api)
* [Issues
  391](https://github.com/Wei-Shaw/sub2api/issues)
* [Pull requests
  50](https://github.com/Wei-Shaw/sub2api/pulls)
* [Actions](https://github.com/Wei-Shaw/sub2api/actions)
* [Projects](https://github.com/Wei-Shaw/sub2api/projects)
* [Security
  1](https://github.com/Wei-Shaw/sub2api/security)
* [Insights](https://github.com/Wei-Shaw/sub2api/pulse)
...
* [Pull requests](https://github.com/Wei-Shaw/sub2api/pulls)
* [Actions](https://github.com/Wei-Shaw/sub2api/actions)
* [Projects](https://github.com/Wei-Shaw/sub2api/projects)
* [Security](https://github.com/Wei-Shaw/sub2api/security)
* [Insights](https://github.com/Wei-Shaw/sub2api/pulse)
...
1. [sub2api](https://github.com/Wei-Shaw/sub2api/tree/main)
...
[JerryFan626](https://github.com/Wei-Shaw/sub2api/commits?author=JerryFan626)

and

[claude](https://github.com/Wei-Shaw/sub2api/commits?author=claude)

[docs: update `docker-compose` commands to Docker Compose V2 syntax](https://github.com/Wei-Shaw/sub2api/commit/f2f819d70f0c748692639637c3b689e3b4d0769b)
...
[f2f819d](https://github.com/Wei-Shaw/sub2api/commit/f2f819d70f0c748692639637c3b689e3b4d0769b) · Mar 19, 2026

History
-------

[History](https://github.com/Wei-Shaw/sub2api/commits/main/README_CN.md)

Open commit details

History

646 lines (461 loc) · 18.7 KB
...
[Raw](https://github.com/Wei-Shaw/sub2api/raw/refs/heads/main/README_CN.md)
...
[English](https://github.com/Wei-Shaw/sub2api/blob/main/README.md) | 中文
...
|  |  |
| --- | --- |
|  | **[PinCC](https://shop.pincc.ai/)** 是基于 Sub2API 搭建的官方中转服务，提供 Claude Code、Codex、Gemini 等主流模型的稳定中转，开箱即用，免去自建部署与运维烦恼。 |
...
curl -sSL https://raw.githubusercontent.com/Wei-Shaw/sub2api/main/deploy/docker-deploy.sh |
 bash
...
* ✅ 开发/测试环境的本地服务器（[http://localhost）](http://localhost%EF%BC%89)
* ✅ 内网可信端点
* ✅ 获取 HTTPS 前测试账号连通性
* ❌ 生产环境（仅使用 HTTPS）
...
# Reference
- [89] [sub2api/README_CN.md at main · Wei-Shaw/sub2api · GitHub](https://github.com/Wei-Shaw/sub2api/blob/main/README_CN.md)
