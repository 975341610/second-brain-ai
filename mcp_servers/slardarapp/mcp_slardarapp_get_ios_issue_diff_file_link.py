...
if __name__ == '__main__':
    try:
        print(call_aime_tool(toolset="SlardarApp", tool_name="mcp:SlardarApp_get_ios_issue_diff_file_link", parameters=json.loads(" ".join(sys.argv[1:])), response_format="text"))
