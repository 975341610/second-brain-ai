...
export function CodeBlockComponent({ node, updateAttributes, extension }: NodeViewProps) {
  ...
  return (
    <NodeViewWrapper 
      as="div" 
      className="code-block-wrapper relative group/code-block my-6"
    >
      ...
      <pre className="relative notion-code-block bg-stone-50/50 border-x border-b border-t-0 border-stone-200 rounded-b-lg overflow-x-auto transition-colors group-hover/code-block:bg-stone-50 p-4">
        <code>
